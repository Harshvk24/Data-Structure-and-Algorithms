...
public class Main {
    ...
    private static void play(LinkedList<Song> playList){
        ...
        if(playList.size()==0){
            System.out.println("This List have no song");
        }
        else {
            ...
            switch (action){
                ...
                case 1:
                    ...
                    if(listIterator.hasNext()){
                        ...
                        System.out.println("no song available, reached to the end to the list");
                        forward = false;
                    }
                    break;
                case 2:
                ...
                case 3:
                    if(forward){
                        if(listIterator.hasPrevious()){
                            System.out.println("Now playiong "+listIterator.previous().toString() );
                            forward=false;
                        }
                        else {
